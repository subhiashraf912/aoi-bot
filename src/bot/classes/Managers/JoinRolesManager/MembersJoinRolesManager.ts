...
class MembersJoinRolesManager {
  ...
  async create(
    ...
    const configuration =
      await this.client.database.models.memberJoinRoles.create(options);
  ...
  async update(
    ...
    let databaseConfiguration =
      await this.client.database.models.memberJoinRoles.findOneAndUpdate(
        {
          guildId,
        },
        options,
  ...
  async fetch(guildId: Snowflake) {
    let databaseConfiguration =
      await this.client.database.models.memberJoinRoles.findOne({
        guildId,
      });
...
export default MembersJoinRolesManager;
