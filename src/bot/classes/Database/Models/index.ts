...
import WelcomeScreenSchema from "./WelcomeScreenSchema";
import WelcomeSystemSchema from "./WelcomeSystemSchema";
class Models {
  ...
  welcomeScreens = WelcomeScreenSchema;
  welcomeSystem = WelcomeSystemSchema;
}
